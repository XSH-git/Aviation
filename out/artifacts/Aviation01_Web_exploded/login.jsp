    ...
    <style type="text/css">
        * {
        ...
        .main {
            width: 100%;
            height: 100%;
            background: url("./images/nh.jpg") 100% 100% no-repeat;
        }
        ...
        .loginFrame .enterBut {
            ...
            /*margin: 40px auto;*/
            border-radius: 50px;
            background-image: linear-gradient(to right, #1ad4ce, #21cdfa);
            text-align: center;
            padding-top: 10px;
            box-sizing: border-box;
            font-size: 20px;
...
<body>
    <div class="main">
        <form action="loginUser" method="post" onsubmit="toValidate()">
...
<%--                <div class="enterBut">--%>
                   <button type="submit" class="enterBut" style="margin:40px 255px; ">登入</button>
